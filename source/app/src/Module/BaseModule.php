...
use AppCore\Infrastructure\Persistence\OrderRepository;
use AppCore\Infrastructure\Persistence\PaymentIntentRepository;
use AppCore\Infrastructure\Persistence\PopularProductRepository;
use AppCore\Infrastructure\Persistence\ProductRepository;
use AppCore\Infrastructure\Persistence\ProductShopStockRepository;
use AppCore\Infrastructure\Persistence\ProductStockistNotificationRecipientRepository;
use AppCore\Infrastructure\Persistence\PurposeRepository;
use AppCore\Infrastructure\Persistence\RefundRepository;
use AppCore\Infrastructure\Persistence\SellerPaymentMethodRepository;
use AppCore\Infrastructure\Persistence\SellerTopicRepository;
...
use MyVendor\MyProject\Annotation\Qualifier\ConsumerPaymentMethod;
use MyVendor\MyProject\Annotation\Qualifier\SellerPaymentMethod;
...
//        $this->bind(TransportInterface::class)->annotatedWith('queue')->to(QueueMail::class)->in(Scope::SINGLETON);
    ...
    private function persistence(): void
    {
        ...
        $this->bind(OrderRepositoryInterface::class)->to(OrderRepository::class)->in(Scope::SINGLETON);
        $this->bind(PaymentIntentRepositoryInterface::class)->to(PaymentIntentRepository::class)->in(Scope::SINGLETON);
        $this->bind(PaymentMethodRepositoryInterface::class)->annotatedWith(ConsumerPaymentMethod::class)->to(ConsumerPaymentMethodRepository::class)->in(Scope::SINGLETON);
        $this->bind(PaymentMethodRepositoryInterface::class)->annotatedWith(SellerPaymentMethod::class)->to(SellerPaymentMethodRepository::class)->in(Scope::SINGLETON);
        $this->bind(PopularProductRepositoryInterface::class)->to(PopularProductRepository::class)->in(Scope::SINGLETON);
        $this->bind(ProductRepositoryInterface::class)->to(ProductRepository::class)->in(Scope::SINGLETON);
        $this->bind(ProductShopStockRepositoryInterface::class)->to(ProductShopStockRepository::class)->in(Scope::SINGLETON);
        $this->bind(ProductStockistNotificationRecipientRepositoryInterface::class)->to(ProductStockistNotificationRecipientRepository::class)->in(Scope::SINGLETON);
        $this->bind(PurposeRepositoryInterface::class)->to(PurposeRepository::class)->in(Scope::SINGLETON);
        $this->bind(RefundRepositoryInterface::class)->to(RefundRepository::class)->in(Scope::SINGLETON);
        $this->bind(SellerTopicRepositoryInterface::class)->to(SellerTopicRepository::class)->in(Scope::SINGLETON);
